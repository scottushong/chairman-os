...
const PATHS: Record<IconName, string> = {
  ...
  eye: 'M12 5.5c-4.5 0-8 3.4-9.5 6.5 1.5 3.1 5 6.5 9.5 6.5s8-3.4 9.5-6.5C20 8.9 16.5 5.5 12 5.5ZM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z',
  'eye-off': 'M4 4l16 16M9.9 9.9A3 3 0 0 0 12 15a3 3 0 0 0 2.1-.9M6.3 6.4C4.5 7.7 3.2 9.5 2.5 12c1.5 3.1 5 6.5 9.5 6.5 1.7 0 3.3-.5 4.7-1.3M14.5 6c-.8-.3-1.6-.5-2.5-.5-.6 0-1.2.1-1.8.2M19 8.4c1 1 1.8 2.2 2.5 3.6-.5 1.1-1.3 2.3-2.3 3.3',
