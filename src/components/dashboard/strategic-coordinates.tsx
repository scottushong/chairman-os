...
import { businessName, criticalRisks, monthlyPriorities, nextMilestones, topGoals } from '@/data'
    ...
    <section aria-label="Strategic Coordinates">
      ...
      <div className="grid grid-cols-1 gap-2.5 md:grid-cols-2 xl:grid-cols-4">
        ...
        <Card spec="CH-013" label="Critical Risk" icon="shield">
          ...
          <p className="mt-1 text-[11px] text-ink-muted">{businessName(risk.business_id)}</p>
        ...
        <Card spec="CH-014" label="Next Milestone" icon="calendar">
          ...
          <p className="mt-1 text-[11px] text-ink-muted">
            {businessName(milestone.business_id)} · 담당 {milestone.owner}
          </p>
