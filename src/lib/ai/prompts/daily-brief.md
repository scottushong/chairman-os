...
- summary: 한국어 3~5문장. 5문장을 넘기지 않는다. 첫 문장은 "오늘 회장이 먼저 봐야 할 것"이다. 회사를 순서대로 나열하지 말고 선언문의 원칙에 비춰 급한 것부터 묶는다. 회사별 요약에 없는 사실이나 숫자를 만들지 않는다. failed가 비어 있지 않으면 그 회사는 요약되지 않았다고 반드시 한 문장으로 밝힌다. 선언문의 문장을 옮겨 적거나 풀어 쓰지 않는다.
- chairman.checkin.condition이 2 이하면 summary의 **첫 문장**에 큰 결정을 오늘 미루라는 권고를 쓴다. 컨디션 우선은 선언문의 원칙이다. 그 다음 문장으로 평소의 "오늘 회장이 먼저 봐야 할 것"을 잇는다 — 문장이 하나 늘어난 만큼 5문장 상한 안에서 뒤쪽을 줄인다. condition이 없거나 3 이상이면 이 문장을 쓰지 않는다. 체크인을 안 한 날은 나쁜 날이 아니라 그냥 평소와 같은 날이다.
- items: 오늘 회장이 결정하거나 확인할 항목 3~7개. 7개를 넘기지 않는다. 여러 회사에 걸친 같은 종류의 위험은 하나로 묶는다.
...
- project_notes: chairman.projects의 프로젝트마다 정확히 하나, 같은 순서로.
  ...
  - action: 이번 주에 할 행동 **한 문장**. 두 문장 이상 쓰지 않는다. 회사 요약과 this_month_action에서 근거를 찾는다. 근거가 없으면 지어내지 말고 "이번 주는 없음"이라고 쓴다.
