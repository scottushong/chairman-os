 ...
 *
 * 인사말 줄에 있던 D-day 알약(ChairmanDdayCard)과 같은 데이터 — 진행 중인 장기 프로젝트 중
 * 목표일이 가장 가까운 한 건, projectClock()로 계산한 D-day·경과율 — 를 훨씬 크게 보여 준다.
 * 데이터를 새로 읽지 않는다(요구사항: 데이터 흐름 불변). 그 알약은 P5-2 리뷰 1라운드에서
 * 지웠다 — 같은 한 건을 한 화면에 두 번 그리는 것이라, 이 카드가 그 자리를 대신한다.
 *
